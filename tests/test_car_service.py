...
class TestCarService(unittest.TestCase):
    ...
    def test_db_status_success(mocked_send_get, mocked_wait, mocked_send_patch):
        ...
        context_patch()
        mocked_send_get.return_value = JsonResponse(200, 'database_missing_indexes.json')
        job_id = """{
                      "job_id": "84cb53ee-58a2-4d49-b0c3-ad4370008841-ACCT_722724471"
                    }"""
    ...
    def test_delete_data_failed(mocked_send_delete):
        ...
        context().car_service.delete('asset', external_id)
        assert True
    ...
    @patch('car_framework.communicator.Communicator.get')
    def test_attribute_search_exception(self, mock_get_request):
        ...
        # print(mock_get_request.side_effect)

        assert the_exception.args[0] is mock_get_request.side_effect
