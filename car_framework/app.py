...
class BaseApp(object):
    def __init__(self, description):
        ...
        self.parser.add_argument('-connection_test', dest='connection_test', action='store_true', default=os.getenv('DATASOURCE_CONNECTION_TEST', False), help='Only perform datasource connection test and exit')
